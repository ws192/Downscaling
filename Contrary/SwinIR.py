...
class Swin2SR(nn.Module):
    ...
    def __init__(self, img_size=(160,240), patch_size=8, in_chans=1,
                 embed_dim=64, depths=[2, 2, 2, 2], num_heads=[2, 2, 2, 2],
                 window_size=7, mlp_ratio=2., qkv_bias=True,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
                 norm_layer=nn.LayerNorm, ape=False, patch_norm=True,
                 use_checkpoint=False, upscale=8, img_range=1., upsampler='pixelshuffle', resi_connection='1conv',
                 **kwargs):
