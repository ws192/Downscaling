...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, num_classes, config=[2, 2, 6, 2], dim=96, drop_path_rate=0.2, input_resolution=64):
        ...
        begin = 0
        self.stage1 = [nn.Conv2d(2, dim, kernel_size=4, stride=4),
...
def Swin_T(num_classes, config=[2, 6,0,0], dim=96, **kwargs):
...
if __name__ == '__main__':
    ...
    print(test_model)
    dummy_input = torch.rand(8, 2, 64, 64).cuda()
